                  ...
                  <div className=' flex flex-col '>
                   ...
                   <div className=' flex flex-col '>
                        ...
                        <input {...register("password",{required:true})}
                         type="password"
                          className='border border-gray-200 px-3 py-2 rounded-[6px] w-90'placeholder='Enter the Password' />
                    </div>
                    <div className=' flex flex-col '>
                        <label className='mb-3'>Confirm Password</label>
                        <input type="password" {...register("password",{required:"Please fill the All Field"})}  className='border border-gray-200 px-3 py-2 rounded-[6px] w-90'  placeholder='Confirm Password' />
