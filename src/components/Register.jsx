            ...
            <div className='border border-gray-200 shadow-2xl p-10 rounded-[15px]'>
                ...
                <form  className='flex flex-col gap-5 mb-4'>
                  <div className=' flex flex-col '>
                        ...
                        <input type="text" className='border border-gray-200 px-3 py-2 rounded-[6px] w-90' type="email" placeholder='Ex.Sachin Bind' />
                    </div>
                    <div className=' flex flex-col '>
                   ...
                   <div className=' flex flex-col '>
                    ...
                    <div className=' flex flex-col '>
                        ...
                        <input type="password" className='border border-gray-200 px-3 py-2 rounded-[6px] w-90' type="email" placeholder='Confirm Password' />
                    </div>
