...
const Home = () => {
  let {blogformData,setBlogFormData}= useContext(BlogStore)
  console.log(blogformData)

  return (
    <div className='px-[180px] mt-18'>
      <div className='flex flex-col justify-center items-center'>
        <h1 className='font-bold text-5xl'>Welcome to <span className='text-blue-600'>Inkwell</span></h1>
